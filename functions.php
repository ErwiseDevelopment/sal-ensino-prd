...
function mantenedora_create_page() {
	...
	if( function_exists('acf_add_options_page') ) {	
        ...
        acf_add_options_page( 
            array( 
                'page_title' => 'Nossas Escolas', 
                'menu_title' => 'Nossas Escolas', 
                'menu_slug'  => 'nossas_escolas', 
                'capability' => 'edit_posts', 
                'position'   => '23,2', 
                'redirect'   => false, 
        ...
        acf_add_options_page( 
            array( 
                'page_title' => 'Ensino Superior', 
                'menu_title' => 'Ensino Superior', 
                'menu_slug'  => 'ensino_superior', 
                'capability' => 'edit_posts', 
                'position'   => '23,3', 
                'redirect'   => false, 
                'icon_url'   => 'dashicons-admin-home',
